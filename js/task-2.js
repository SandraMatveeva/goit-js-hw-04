...
//   спожитих спортсменом, у цей день.Візьми код нижче і встав
//   після оголошення своєї функції для перевірки коректності її роботи.
...
function calcAverageCalories(days) {
  ...
  for (const element of days) {
    totalCalor = totalCalor + element.calories;
  }
  averageCalor = totalCalor / 7;
  return averageCalor;
}
